...
const documents = {
    ...
    "query CollectionsWithProductsNames {\n  collections {\n    data {\n      name\n      slug\n      id\n      products {\n        name\n      }\n    }\n  }\n}": types.CollectionsWithProductsNamesDocument,
 ...
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(source: "query CollectionsWithProductsNames {\n  collections {\n    data {\n      name\n      slug\n      id\n      products {\n        name\n      }\n    }\n  }\n}"): typeof import('./graphql').CollectionsWithProductsNamesDocument;
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
